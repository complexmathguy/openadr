...
public class ObjectOperationProjector extends ObjectOperationEntityProjector {
    ...
    /*
     * @param	event AssignOperationsToObjectOperationEvent
     */
    @EventHandler( payloadType=AssignOperationsToObjectOperationEvent.class)
    public void handle( AssignOperationsToObjectOperationEvent event) {
	    LOGGER.info("handling AssignOperationsToObjectOperationEvent - " + event );
	    
	    // ------------------------------------------
    	// delegate to addTo 
    	// ------------------------------------------ 
	    ObjectOperation entity = addToOperations(event.getObjectOperationId(), event.getAddTo() );
...
/*
 * @param	event RemoveOperationsFromObjectOperationEvent
 */
@EventHandler( payloadType=RemoveOperationsFromObjectOperationEvent.class)
public void handle( RemoveOperationsFromObjectOperationEvent event) {
    LOGGER.info("handling RemoveOperationsFromObjectOperationEvent - " + event );

    ObjectOperation entity = removeFromOperations(event.getObjectOperationId(), event.getRemoveFrom() );

...
public class VenEntityProjector {
     ...
     * @return	Ven
     */
    public Ven addToAttributes( UUID parentId, ValueMap addTo ) {
     ...
     * @return	Ven
     */
	public Ven removeFromAttributes( UUID parentId, ValueMap removeFrom ) {
     ...
     * @return	Ven
     */
    public Ven addToTargets( UUID parentId, ValueMap addTo ) {
     ...
     * @return	Ven
     */
	public Ven removeFromTargets( UUID parentId, ValueMap removeFrom ) {

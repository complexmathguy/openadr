...
public class ResourceEntityProjector {
     ...
     * @return	Resource
     */
    public Resource addToAttributes( UUID parentId, ValuesMape addTo ) {
	    LOGGER.info("handling AssignAttributesToResourceEvent - " );
	    
	    Resource parentEntity = repository.findById(parentId).get();
	    ValuesMape child = ValuesMapeProjector.find(addTo.getValuesMapeId());
     ...
     * @return	Resource
     */
	public Resource removeFromAttributes( UUID parentId, ValuesMape removeFrom ) {
	    LOGGER.info("handling RemoveAttributesFromResourceEvent " );
	
	    Resource parentEntity = repository.findById(parentId).get();
	    ValuesMape child = ValuesMapeProjector.find(removeFrom.getValuesMapeId());
     ...
     * @return	Resource
     */
    public Resource addToTargets( UUID parentId, ValuesMape addTo ) {
     ...
     * @return	Resource
     */
	public Resource removeFromTargets( UUID parentId, ValuesMape removeFrom ) {
    ...
    @Autowired
	@Qualifier(value = "valuesMape-entity-projector")
	ValuesMapeEntityProjector ValuesMapeProjector;

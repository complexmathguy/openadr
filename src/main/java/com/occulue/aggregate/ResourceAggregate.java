...
public class ResourceAggregate {  
    ...
    public void handle(AssignAttributesToResourceCommand command) throws Exception {
    	...
    	if ( attributes.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Attributes already contains an entity with id " + command.getAddTo().getValuesMapeId() );
    ...
    public void handle(RemoveAttributesFromResourceCommand command) throws Exception {
    	...
    	if ( !attributes.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Attributes does not contain an entity with id " + command.getRemoveFrom().getValuesMapeId() );
    ...
    public void handle(AssignTargetsToResourceCommand command) throws Exception {
    	...
    	if ( targets.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Targets already contains an entity with id " + command.getAddTo().getValuesMapeId() );
    ...
    public void handle(RemoveTargetsFromResourceCommand command) throws Exception {
    	...
    	if ( !targets.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Targets does not contain an entity with id " + command.getRemoveFrom().getValuesMapeId() );
    ...
    private Set<ValuesMape> attributes = new HashSet<>();
    private Set<ValuesMape> targets = new HashSet<>();

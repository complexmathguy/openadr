...
public class VenAggregate {  
    ...
    public void handle(AssignAttributesToVenCommand command) throws Exception {
    	...
    	if ( attributes.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Attributes already contains an entity with id " + command.getAddTo().getValueMapId() );
    ...
    public void handle(RemoveAttributesFromVenCommand command) throws Exception {
    	...
    	if ( !attributes.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Attributes does not contain an entity with id " + command.getRemoveFrom().getValueMapId() );
    ...
    private Set<ValueMap> attributes = new HashSet<>();

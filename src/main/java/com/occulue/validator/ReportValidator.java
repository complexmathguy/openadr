...
//		Assert.isNull( report.getReportId(), "CreateReportCommand identifier should be null" );
		...
		Assert.notNull( report.getIntervalPeriod(), "Field CreateReportCommand.intervalPeriod should not be null" );
	}
	...
	public void validate( UpdateReportCommand report ) throws Exception {
		...
		Assert.notNull( report.getIntervalPeriod(), "Field UpdateReportCommand.intervalPeriod should not be null" );
    }

...
//		Assert.isNull( resource.getResourceId(), "CreateResourceCommand identifier should be null" );
	...
	public void validate( RemoveAttributesFromResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom().getValuesMapeId(), "RemoveAttributesFromResourceCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( RemoveTargetsFromResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom().getValuesMapeId(), "RemoveTargetsFromResourceCommand removeFrom attribubte identifier should not be null" );
	}

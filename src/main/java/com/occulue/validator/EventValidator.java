...
//		Assert.isNull( event.getEventId(), "CreateEventCommand identifier should be null" );
		...
		Assert.notNull( event.getIntervalPeriod(), "Field CreateEventCommand.intervalPeriod should not be null" );
	}
	...
	public void validate( UpdateEventCommand event ) throws Exception {
		...
		Assert.notNull( event.getIntervalPeriod(), "Field UpdateEventCommand.intervalPeriod should not be null" );
    }

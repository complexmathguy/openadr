...
//		Assert.isNull( ven.getVenId(), "CreateVenCommand identifier should be null" );
	...
	public void validate( RemoveAttributesFromVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom().getValueMapId(), "RemoveAttributesFromVenCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( RemoveTargetsFromVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom().getValueMapId(), "RemoveTargetsFromVenCommand removeFrom attribubte identifier should not be null" );
	}

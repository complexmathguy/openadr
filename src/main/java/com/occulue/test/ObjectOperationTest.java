...
public class ObjectOperationTest{
	...
	protected CreateObjectOperationCommand generateNewCommand() {
        CreateObjectOperationCommand command = new CreateObjectOperationCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
	...
	protected UpdateObjectOperationCommand generateUpdateCommand() {
	        UpdateObjectOperationCommand command = new UpdateObjectOperationCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0],  new HashSet<>() );

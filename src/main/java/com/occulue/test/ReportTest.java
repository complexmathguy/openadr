...
public class ReportTest{
	...
	protected CreateReportCommand generateNewCommand() {
        CreateReportCommand command = new CreateReportCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),   "",  new Interval(),  ObjectType.values()[0] );
	...
	protected UpdateReportCommand generateUpdateCommand() {
	        UpdateReportCommand command = new UpdateReportCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),   "",  null,  null,  new HashSet<>(),  new HashSet<>(),  new Interval(),  ObjectType.values()[0] );

...
//************************************************************************
    ...
    */
	...
	public void addToAttributes( AssignAttributesToVenCommand command ) throws ProcessingException {
		...
		ValueMapBusinessDelegate childDelegate 	= ValueMapBusinessDelegate.getValueMapInstance();
		VenBusinessDelegate parentDelegate = VenBusinessDelegate.getVenInstance();		
		UUID childId = command.getAddTo().getValueMapId();
		...
		try {		
			...
			final String msg = "Failed to add a ValueMap as Attributes to Ven" ; 
    ...
    /**
     * remove ValueMap from Attributes
	...
	public void removeFromAttributes( RemoveAttributesFromVenCommand command ) throws ProcessingException {		
		...
		ValueMapBusinessDelegate childDelegate 	= ValueMapBusinessDelegate.getValueMapInstance();
		UUID childId = command.getRemoveFrom().getValueMapId();
	...
	public void addToTargets( AssignTargetsToVenCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a ValueMap as Targets to Ven" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}

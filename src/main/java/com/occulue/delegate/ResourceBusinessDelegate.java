...
//************************************************************************
    ...
    */
	...
	public void addToAttributes( AssignAttributesToResourceCommand command ) throws ProcessingException {
		...
		ValuesMapeBusinessDelegate childDelegate 	= ValuesMapeBusinessDelegate.getValuesMapeInstance();
		ResourceBusinessDelegate parentDelegate = ResourceBusinessDelegate.getResourceInstance();		
		UUID childId = command.getAddTo().getValuesMapeId();
		...
		try {		
			...
			final String msg = "Failed to add a ValuesMape as Attributes to Resource" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove ValuesMape from Attributes
	...
	public void removeFromAttributes( RemoveAttributesFromResourceCommand command ) throws ProcessingException {		
		...
		ValuesMapeBusinessDelegate childDelegate 	= ValuesMapeBusinessDelegate.getValuesMapeInstance();
		UUID childId = command.getRemoveFrom().getValuesMapeId();
	...
	public void addToTargets( AssignTargetsToResourceCommand command ) throws ProcessingException {
		...
		try {		
			...
			final String msg = "Failed to add a ValuesMape as Targets to Resource" ; 
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
    ...
    /**
     * remove ValuesMape from Targets

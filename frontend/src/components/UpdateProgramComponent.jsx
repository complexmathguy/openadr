...
class UpdateProgramComponent extends Component {
    constructor(props) {
        ...
        this.changeintervalPeriodHandler = this.changeintervalPeriodHandler.bind(this);
    ...
    componentDidMount(){
        ProgramService.getProgramById(this.state.id).then( (res) =>{
            ...
            this.setState({
                ...
                intervalPeriod: program.intervalPeriod,
    ...
    updateProgram = (e) => {
        ...
        let program = {
            ...
            intervalPeriod: this.state.intervalPeriod,
    ...
    changeintervalPeriodHandler= (event) => {
        this.setState({intervalPeriod: event.target.value});
    }
